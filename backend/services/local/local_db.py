...
device_delete_redactions_collection = db["device_delete_redactions"]
device_approval_requests_collection = db["device_approval_requests"]
device_cron_logs_collection = db["device_cron_logs"]
device_vulnerabilities_collection = db["device_vulnerabilities"]